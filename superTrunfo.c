...
// Função para comparar cartas pelo PIB per capita
void compararCartasPorPIBperCapita(struct Carta carta1, struct Carta carta2)
{
       printf("\nComparação de cartas (Atributo: PIB per capita):\n");
       printf("\nCarta 1 - %s: %.2f reais", carta1.cidade, carta1.pibPerCapita);
       printf("\nCarta 2 - %s: %.2f reais", carta2.cidade, carta2.pibPerCapita);
...
int main()
{
       ...
       // Realizar comparação específica por PIB per capita
       compararCartasPorPIBperCapita(carta1, carta2);
